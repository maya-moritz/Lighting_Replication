...
*	File: Appendix_Table_5
*	Script purpose: create Appendix Table 5, main results with 2 years pre-time
*	Author: Maya Moritz
*	Input: ${data_folder_processed}
*	Output: "${output_tables_folder}/Appendix/Table_A5/2years_kde_`i'`j'.rtf"
*******************************************************************************/
cap mkdir ${output_tables_folder}/Appendix/Table_A5/
clear
eststo clear
...
esttab using "${output_tables_folder}/Appendix/Table_A5/2years_kde_`i'`j'.html", ///
    keep(lambda_cumr) ///
    ...
    note(Standard errors in parentheses; Hexagon and year-month fixed effects. Data utilized is from July 2021 through April 2024) ///
	replace
	}
}
