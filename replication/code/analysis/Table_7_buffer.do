...
*	File: Table_7_buffer
*	Script purpose: create Table 7 (time buffers)
*	Author: Maya Moritz
*	Input: ${data_folder_processed}/buffer
*	Output: "${output_tables_folder}/Table_7/buffer_kde_`i'`j'.rtf"
*******************************************************************************/
clear
eststo clear
cap mkdir ${output_tables_folder}/Table_7_buffer/
cd ${data_folder_processed}/buffer
...
esttab using "${output_tables_folder}/Table_7_buffer/buffer_kde_`i'`j'.html", ///
    keep(lambda_cumr) ///
